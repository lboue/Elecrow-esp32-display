...
#define bleServerName "Wizee-Series-4.3"  //Name of the BLE server
...
extern lv_obj_t * ui_touch_calibrate;//calibration widget
...
void setup()
{
  ...
  cardSerial.begin(SERIAL_BAUD, SERIAL_8N1, 18, 17);//4.3 /*Serial Port Initializing 1*/
  first_flag = 0;
